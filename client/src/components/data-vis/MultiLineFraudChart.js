...
class MultiLineFraudChart extends Component {
  constructor(props) {
    super(props);
  ...
  createLineChart() {
    ...
    if (shareNames.length > 0) {
      ...
      x.domain([0, this.props.data[shareNames[0]].data.length - 1]);
      ...
      let yOffset = originRatio * height + 10;
      svg
        .append("g")
      ...
      let xGridOffset = height + 10;
      svg
        .append("g")
        .attr("class", "grid")
        .attr("transform", "translate(30," + xGridOffset + ")")
        .call(
